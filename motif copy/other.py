...
def score(motifes):
    ...
    print("The consesus is: " + consensus)
    score = 0
...
def greedy_motif_search(Dna, k, t):
    ...
    while start + k <= length:
        ...
        for i in range(1, t):
            ...
            print(motifes)
            print("Score for motifes")
            s_motif = score(motifes)
            print("Score for best_motif")
            bs_motif = score(best_motif)
            print(f"{s_motif}  {bs_motif}")
